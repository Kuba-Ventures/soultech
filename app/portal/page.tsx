...
export default async function PortalHome() {
  ...
  // First sign-in: bounce into onboarding before showing the dashboard.
    ...
    <div className="px-8 py-12 max-w-4xl">
      ...
      {onboardingInProgress && (
        <Link
          ...
          className="mt-6 flex items-center justify-between gap-4 rounded-2xl border border-amber-400/25 bg-amber-400/[0.04] px-5 py-3 text-sm hover:border-amber-400/40 transition"
        >
